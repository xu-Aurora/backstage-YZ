            ...
            self.props.updateLogistics({
              ...
              func: function () {
                  message.success('操作成功', 1.5, ()=>{
                    self.props.search('logisticsVisible');
                  });
              }
            })
          })
        ...
        <div style={{width: '100%',backgroundColor: "#FFF",marginTop: 2}}>
            ...
            <Row>
                      ...
                      <TabPane tab="" key="1">
                        ...
                        <FormItem {...formItemLayout} label="配送员名称" style={{marginBottom:15}}>
                            {getFieldDecorator('distributorName')(
                                <Input  style={{width:'35%'}} placeholder="输入配送员名称" maxLength={50} />
                            )}
                        </FormItem>
                        <FormItem {...formItemLayout} label="配送员电话">
                            {getFieldDecorator('distributorPhone')(
                                <Input  style={{width:'35%'}} placeholder="输入配送员电话" maxLength={50} />
                            )}
                        </FormItem>
                      </TabPane>
                      <TabPane tab="" key="2">
                ...
                {/* <Col style={{textAlign:'center',marginTop:50}}>
                  <Button type="primary" onClick={this.handleTal.bind(this,'1')}>物流配送</Button>
                  <Button type="primary" onClick={this.handleTal.bind(this,'2')}>买家自取</Button>
                  <Button type="primary" onClick={this.handleTal.bind(this,'3')}>快递</Button>
                </Col> */}
            </Row>
        </div>
...
function dispatchToProps(dispatch) {
  return {
    ...
    updateLogistics(payload = {}) {
      dispatch({type: 'orderList/updateLogistics', payload})
    },
  }
}
