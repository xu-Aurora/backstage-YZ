...
class App extends Component {
  ...
  regx(item) {
    console.log(this.props.data.way);
    //手机号码正则
        ...
        <div style={{width: '100%',backgroundColor: "#FFF",marginTop: 2}}>
            ...
            <Row>
                ...
                {/* <Col style={{textAlign:'center',marginTop:50}}>
                  ...
                  <Button type="primary" onClick={this.handleTal.bind(this,'3')}>买家自取</Button>
                  <Button type="primary" onClick={this.handleTal.bind(this,'2')}>快递</Button>
                </Col> */}
            </Row>
        </div>
