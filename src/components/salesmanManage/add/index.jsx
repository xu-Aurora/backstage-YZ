              ...
              <table cellSpacing="0" className={Style.mytable}>
                <tbody>
                  <tr>
                    ...
                    <td colSpan={3}>
                      {getFieldDecorator('salesmanName', {initialValue:''})(
                        <Input placeholder="请输入业务员名称" maxLength={10}/>
                      )}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td colSpan={3}>
                      {getFieldDecorator('salesmanPhone', {initialValue:''})(
                  ...
                  <tr>
                    ...
                    <td colSpan={3}>
                      {getFieldDecorator('salesmanType', {})(
...
function dispatchToProps(dispatch) {
  return {
    ...
    add(payload = {}) {
      dispatch({type: 'salesmanManage/add', payload})
    },
