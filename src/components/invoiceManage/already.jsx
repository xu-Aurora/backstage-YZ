...
import CancelInvoice from './already/cancelInvoice.jsx';
import UpdateInvoice from './already/updateInvoice.jsx';
    ...
    if (showScreen) {
      Element = (
        <Row style={{marginTop: '15px'}}>
          ...
          <Col xl={5} xxl={4} style={{marginTop: '15px'}}>
            <FormItem label="开票状态" {...formItemLayout1}>
              <Select style={{ width: '100%'}}
          ...
          <Col style={{marginTop: '15px',textAlign:"center"}} span={3} offset={10}>
    ...
    return (
      <div className={styles.commonBox}>
        ...
        <Drawer
          ...
          placement="right"
          destroyOnClose
          onClose={this.handleCancel.bind(this, 'updateVisible')}
          maskClosable={false}
          visible={this.state.updateVisible}
          style={{overflow: 'auto',paddingBottom: 53}}
          >
          <UpdateInvoice search={this.search.bind(this)}/>
        </Drawer>
        ...
        <Drawer
          ...
          placement="right"
          destroyOnClose
          onClose={this.handleCancel.bind(this, 'cancelVisible')}
          maskClosable={false}
          visible={this.state.cancelVisible}
          style={{overflow: 'auto',paddingBottom: 53}}
          >
          <CancelInvoice search={this.search.bind(this)}/>
        </Drawer>
