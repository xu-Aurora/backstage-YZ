...
class App extends Component {
  ...
  componentWillMount() {
    ...
    let self = this
    self.props.getZxhs({
      params: {userId: userData.id, comId : self.props.houseInfo.comId, comCourtId: self.props.houseInfo.comCourtId}
    })
        ...
        if(this.state.requestStatus){
          self.setState({requestStatus: false},() => {
              ...
              if(self.state.houseVal) {
                ...
                addressId = self.props.houseInfo.addressId
                addressName = self.props.houseInfo.addressName
                roomId = self.props.houseInfo.roomId
                roomName = self.props.houseInfo.roomName
              }
              self.props.updateUser({
                params: {
                  ...
                  comId: self.props.houseInfo.comId,
                  comName: self.props.houseInfo.comName,
                  roomId: roomId,
                  roomName: roomName,
                  addressId: addressId,
                  addressName: addressName,
                  comCourtId: self.props.houseInfo.comCourtId,
                  comCourtName: self.props.houseInfo.comCourtName,
                  areaDetail: self.props.houseInfo.areaDetail
                },
                func: function(){
